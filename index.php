...
<style>
  .fondo-imagen {
    background: url(imagenes/f_municipalidad.jpg);
  ...
  <div class="login-box">
    ...
    <div class="card card-outline card-primary">
      <div class="card-header text-center">
        <a href="index.php" class="h1"><b>MUNI</b>CIPIO</a>
      </div>
      <div class="card-body">
        ...
        <form action="" method="post" onsubmit="return false">
          ...
          <div class="row">
            ...
            <!-- /.col -->
            <div class="col-4">
              <button type="button" class="btn btn-secondary btn-block" onclick="IngresarSistema()">Ingresar</button>
            </div>
            <!-- /.col -->
          </div>
          <div class="row">
